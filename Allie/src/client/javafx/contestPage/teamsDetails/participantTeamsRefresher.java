...
public class participantTeamsRefresher extends TimerTask {
    ...
    public participantTeamsRefresher(BooleanProperty shouldUpdate, Consumer<Exception> httpRequestLoggerConsumer, Consumer<List<AlliesDetailDTO>> alliesDataConsumer) {
    ...
    public void run() {
        ...
        HttpClientUtil.runAsync(AlliesConstants.GET_PARTICIPANT_ALLIES, new Callback() {
